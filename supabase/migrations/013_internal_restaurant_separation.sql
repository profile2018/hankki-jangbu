-- Separate restaurants owned/managed by a super-admin from real customer restaurants.
...
begin
  ...
  select
    ...
    exists (
      ...
      join public.super_admins sa on sa.user_id = rm.user_id
  ...
  order by (r.archived_at is not null), is_internal, r.created_at desc;
end;
$$;
