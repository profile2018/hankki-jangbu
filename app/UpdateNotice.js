    ...
    <div className="update-backdrop" role="dialog" aria-modal="true" aria-labelledby="update-title">
      <section className="update-card">
        ...
        <div className="update-items">
          <div><strong>설정 메뉴 안정화</strong><span>PC와 스마트폰 모두 상단 메뉴에서 설정으로 들어갈 수 있도록 개선했습니다.</span></div>
          <div><strong>업데이트 적용 강화</strong><span>업데이트 버튼을 누르면 이전 화면 캐시를 피해서 최신 화면을 다시 불러옵니다.</span></div>
          <div><strong>설정 정보 저장 준비</strong><span>식당 정보, 입금계좌와 키오스크 설정 저장 기능을 연결했습니다.</span></div>
        </div>
